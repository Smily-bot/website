...
(function(w) {
        ...
        for (var c = a.$$hashKey, e = 0, f = b.length; e < f; ++e) {
            ...
            if (B(g) || C(g))
                for (var h = Object.keys(g), k = 0, l = h.length; k < l; k++) {
                    var m = h[k]
                      , p = g[m];
                    d && B(p) ? fa(p) ? a[m] = new Date(p.valueOf()) : $a(p) ? a[m] = new RegExp(p) : p.nodeName ? a[m] = p.cloneNode(!0) : Zb(p) ? a[m] = p.clone() : (B(a[m]) || (a[m] = I(p) ? [] : {}),
                    Yb(a[m], [p], !0)) : a[m] = p
                }
        }
    ...
    function pa(a, b, d) {
        ...
        function e(a, b) {
            ...
            var d = !1
              , e = f(a);
            void 0 === e && (e = I(a) ? [] : Object.create(Pc(a)),
            d = !0);
            g.push(a);
            h.push(e);
            return d ? c(a, e, b) : e
    ...
    function ec(a) {
        ...
        r((a || "").split("&"), function(a) {
            ...
            e = Tc(e),
            u(e) && (f = u(f) ? Tc(f) : !0,
            ra.call(b, e) ? I(b[e]) ? b[e].push(f) : b[e] = [b[e], f] : b[e] = f))
        });
        return b
    }
    function fc(a) {
    ...
    function Uc(a, b, d) {
        ...
        w && e.test(w.name) && (d.debugInfoEnabled = !0,
    ...
    function Be() {
        ...
        if (!Wc) {
            var b = rb();
            (ma = x(b) ? w.jQuery : b ? w[b] : void 0) && ma.fn.on ? (z = ma,
            O(ma.fn, {
                scope: Sa.scope,
            ...
            r(a, function(a) {
                ...
                if (!m.get(a)) {
                    ...
                    try {
                        ...
                        d(c._invokeQueue),
                        d(c._configBlocks)) : C(a) ? b.push(n.invoke(a)) : I(a) ? b.push(n.invoke(a)) : sb(a, "module")
                    } catch (e) {
        ...
        this.$get = ["$window", "$location", "$rootScope", function(b, d, c) {
            ...
            function f(a) {
                if (a) {
                    ...
                    c = g.yOffset;
                    C(c) ? c = c() : Zb(c) ? (c = c[0],
                    c = "fixed" !== b.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : Y(c) || (c = 0);
    ...
    function rg(a, b, d, c) {
        ...
        k.url = function(b, d, e) {
            ...
            if (b) {
                ...
                e = -1 === e ? "" : b.substr(e),
                d.hash = e) : l.href = b,
                l.href !== b && (A = b)) : (m[d ? "replaceState" : "pushState"](e, "", b),
                g());
                A && (A = b);
                return k
            }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, e, p, R, M, T, P, q) {
            ...
            function Ua(a, b, c, d, e, g) {
                function f(a, c, d, e) {
                    ...
                    for (p = h.length; m < p; )
                        ...
                        n = c.transcludeOnThisElement ? Ma(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? Ma(a, b) : null,
            ...
            function K(a, b, c, d, e) {
                ...
                case 1:
                    ...
                    for (var k, l, m, p, n = a.attributes, t = 0, G = n && n.length; t < G; t++) {
                        ...
                        (k = k.match(Qa)) && $(k[1]) && (H = l,
                        F = l.substr(0, l.length - 5) + "end",
            ...
            function Y(a, b, d, e, g, f, h, k, l) {
                ...
                function p(a, e, g, f, l) {
                    ...
                    l && (R = m,
                    R.$$boundTransclude = l,
                    R.isSlotFilled = function(a) {
                        return !!l.$$slots[a]
                    }
                    );
                    H && (M = ea(ga, f, R, H, y, e, J));
                    J && (da.$$addScopeInfo(ga, y, !0, !(A && (A === J || A === J.$$originalDirective))),
                    da.$$addScopeClass(ga, !0),
                    y.$$isolateBindings = J.$$isolateBindings,
                    s = qa(e, f, y, y.$$isolateBindings, J),
                    ...
                    for (n in M) {
                        ...
                        if (F) {
                            ...
                            var q = v();
                            q !== v.instance && (v.instance = q,
                            ga.data("$" + s.name + "Controller", q),
                            v.bindingInfo.removeWatches && v.bindingInfo.removeWatches(),
                            v.bindingInfo = qa(ba, f, v.instance, P, s))
                        } else
                            v.instance = v(),
                            ga.data("$" + s.name + "Controller", v.instance),
                            v.bindingInfo = qa(ba, f, v.instance, P, s)
                    }
                    r(H, function(a, b) {
                        var c = a.require;
                    ...
                    for (s = h.length; n < s; n++)
                        v = h[n],
                        va(v, v.isolateScope ? y : e, ga, f, v.require && X(v.directiveName, v.require, ga, M), R);
                    var N = e;
                ...
                for (var n = -Number.MAX_VALUE, t = l.newScopeDirective, H = l.controllerDirectives, J = l.newIsolateScopeDirective, A = l.templateDirective, y = l.nonTlbTranscludeDirective, ba = !1, M = !1, T = l.hasElementTranscludeDirective, v = d.$$element = z(b), s, R, P, q = e, N, u = !1, Ib = !1, w, Da = 0, D = a.length; Da < D; Da++) {
                    ...
                    if (n > s.priority)
                        break;
                    if (w = s.scope)
                        s.templateUrl || (B(w) ? (aa("new/isolated scope", J || t, s, v),
                        J = s) : aa("new/isolated scope", J, s, v)),
                        t = t || s;
                    R = s.name;
                    ...
                    !s.templateUrl && s.controller && (H = H || S(),
                    aa("'" + R + "' controller", H[R], s, v),
                    H[R] = s);
                    if (w = s.transclude)
                        if (ba = !0,
                        s.$$tlb || (aa("transclusion", y, s, v),
                        y = s),
                        "element" === w)
                            T = !0,
                            n = s.priority,
                            P = v,
                            v = d.$$element = z(da.$$createComment(R, d[R])),
                            b = v[0],
                            ma(g, xa.call(P, 0), b),
                            P[0].$$parentNode = P[0].parentNode,
                            q = W(Ib, P, e, n, f && f.name, {
                    ...
                    if (s.template)
                        ...
                        aa("template", A, s, v),
                        A = s,
                        w = C(s.template) ? s.template(v, d) : s.template,
                        w = Ia(w),
                        s.replace) {
                            f = s;
                    ...
                    if (s.templateUrl)
                        ...
                        A = s,
                        s.replace && (f = s),
                        p = ja(a.splice(Da, a.length - Da), v, d, g, ba && q, h, k, {
                    ...
                    for (var p = 0, n = h.length; p < n; p++)
                        ...
                        (x(g) || g > c.priority) && -1 !== c.restrict.indexOf(e)) {
                            ...
                            if (!c.$$bindings) {
                                ...
                                B(t.scope) && (!0 === t.bindToController ? (H.bindToController = d(t.scope, G, !0),
                                H.isolateScope = {}) : H.isolateScope = d(t.scope, G, !1));
            ...
            function ja(a, b, d, g, f, h, k, l) {
                ...
                return function(a, b, c, d, e) {
                    a = e;
                    b.$$destroyed || (m ? m.push(b, c, d, a) : (p.transcludeOnThisElement && (a = Ma(b, p.transclude, e)),
                    p(n, b, c, d, a)))
                }
            }
            function la(a, b) {
            ...
            function qa(a, c, d, e, g) {
                function f(b, c, e) {
                    C(d.$onChanges) && !cc(c, e) && (ha || (a.$$postDigest(N),
                    ha = []),
                    m || (m = {},
                    ha.push(h)),
    ...
    function yf() {
        ...
        this.$get = ["$injector", "$window", function(d, c) {
            ...
            return function(f, g, h, k) {
                ...
                if (h)
                    return h = (I(f) ? f[f.length - 1] : f).prototype,
    ...
    function Ff() {
        ...
        this.$get = ["$browser", "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", "$sce", function(c, e, f, g, h, k, l, m) {
            ...
            function n(c, d) {
                ...
                M && (T = M.get(N),
                u(T) ? T && C(T.then) ? T.then(G, G) : I(T) ? n(T[1], T[0], ka(T[2]), T[3], T[4]) : n(T, 200, {}, "OK", "complete") : M.put(N, R));
                x(T) && ((T = zd(c.url) ? f()[c.xsrfCookieName || a.xsrfCookieName] : void 0) && (P[c.xsrfHeaderName || a.xsrfHeaderName] = T),
                e(c.method, N, d, l, P, c.timeout, c.withCredentials, c.responseType, g(c.eventHandlers), g(c.uploadEventHandlers)));
                return R
            }
            function F(a, b) {
    ...
    function yc(a, b, d) {
        ...
        this.$$parseLinkUrl = function(c, e) {
            ...
            var f, g;
            u(f = ua(a, c)) ? (g = f,
            g = d && u(f = ua(d, f)) ? b + (ua("/", f) || f) : a + g) : u(f = ua(b, c)) ? g = b + f : b === c + "/" && (g = b);
            g && this.$$parse(g);
            return !!g
        }
    }
    function zc(a, b, d) {
        ...
        this.$$parse = function(c) {
            ...
            x(e) || "#" !== e.charAt(0) ? this.$$html5 ? f = e : (f = "",
            x(e) && (a = c,
            this.replace())) : (f = ua(d, e),
            x(f) && (f = e));
            Bd(f, this, !1);
            c = this.$$path;
            var e = a
            ...
            f.on("click", function(a) {
                ...
                if (e && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 !== a.which && 2 !== a.button) {
                    ...
                    if (!E(e) || !x(h.attr(e))) {
                        ...
                        s.test(e) || !e || h.attr("target") || a.isDefaultPrevented() || !l.$$parseLinkUrl(e, k) || (a.preventDefault(),
                ...
                if (v || l.$$urlUpdatedByLocation) {
                    ...
                    if (v || m)
                        ...
                        d.$evalAsync(function() {
                            ...
                            l.$$state = g) : (m && h(b, f, g === l.$$state ? null : l.$$state),
                            k(a, g)))
                        })
                }
                l.$$replace = !1
        ...
        this.$get = ["$filter", function(e) {
            function f(b, c) {
                ...
                case "string":
                    ...
                    d.constant ? d.$$watchDelegate = m : d.oneTime ? d.$$watchDelegate = d.literal ? l : k : d.inputs && (d.$$watchDelegate = h),
                    a[g] = d),
                    p(d, c);
                case "function":
                    return p(b, c);
            ...
            function p(a, b) {
                ...
                : function(c, d, e, g) {
                  ...
                  , d = !a.inputs;
                c && c !== h ? (e.$$watchDelegate = c,
                e.inputs = a.inputs) : b.$stateful || (e.$$watchDelegate = h,
    ...
    function Ld(a, b, d) {
        ...
        function h(c) {
            !d || c.pending || 2 !== c.status || c.pur || (0 === u && 0 === w.length && a(g),
            w.push(c));
                ...
                try {
                    for (var l = 0, p = h.length; l < p; ++l) {
                        ...
                        try {
                            ...
                            m(f, n),
                            n && !0 === n.$$passToExceptionHandler && b(n)
                        }
                    }
                } finally {
                    --u,
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function(f, g, h) {
            ...
            m.prototype = {
                ...
                $digest: function() {
                    ...
                    p("$digest");
                    h.$$checkUrlChange();
                    this === t && null !== e && (h.defer.cancel(e),
                    v());
                    c = null;
                    do {
                        r = !1;
                                ...
                                for (n.$$digestWatchIndex = n.length; n.$$digestWatchIndex--; )
                                    try {
                                        if (a = n[n.$$digestWatchIndex])
                                            if (m = a.get,
                                            (g = m(q)) !== (k = a.last) && !(a.eq ? sa(g, k) : U(g) && U(k)))
                                                r = !0,
                                                c = a,
    ...
    function Tf() {
        this.$get = ["$window", "$document", function(a, b) {
            var d = {}
              ...
              , k = !1
              , l = !1;
            h && (k = !!("transition"in h || "webkitTransition"in h),
        ...
        this.$get = ["$exceptionHandler", "$templateCache", "$http", "$q", "$sce", function(b, d, c, e, f) {
            function g(h, k) {
                ...
                return c.get(h, O({
                    ...
                    k || (a = Gg("tpload", h, a.status, a.statusText),
                    b(a));
                    return e.reject(a)
                })
            }
    ...
    function Td(a) {
        ...
        function c(a, b) {
            ...
            if (d === k) {
                ...
                l = l.toLowerCase()) : "object" === d && (B(k) && (k = a.index),
                B(l) && (l = b.index));
                k !== l && (c = k < l ? -1 : 1)
            } else
                c = d < k ? -1 : 1;
    ...
    var Mc = {
        objectMaxDepth: 5
    }, Vg = /^\/(.+)\/([a-z]*)$/, ra = Object.prototype.hasOwnProperty, L = function(a) {
    ...
    var I = Array.isArray
      ...
      , rb = function() {
        ...
        for (b = 0; b < d; ++b)
            if (c = Ha[b],
            a = w.document.querySelector("[" + c.replace(":", "\\:") + "jq]")) {
            ...
            if (!f && u(a.watchId))
                ...
                case q.MemberExpression:
                    ...
                    k.recurse(a.object, g, void 0, function() {
                        k.if_(k.notNull(g), function() {
                            ...
                            k.assign(b, m),
                            d && (d.computed = !0,
                            d.name = h)) : (e && 1 !== e && k.if_(k.isNull(k.nonComputedMember(g, a.property.name)), k.lazyAssign(k.nonComputedMember(g, a.property.name), "{}")),
                ...
                case q.ObjectExpression:
                    ...
                    r(a.properties, function(a) {
                        ...
                        k.recurse(a.key, g)) : g = a.key.type === q.Identifier ? a.key.name : "" + a.key.value;
                        h = k.nextId();
                        k.recurse(a.value, h);
        ...
        vb[b] = function() {
            return {
                ...
                link: function(d, c, e) {
                    var f = a
                      , g = a;
                    "href" === a && "[object SVGAnimatedString]" === ia.call(c.prop("href")) && (g = "xlinkHref",
                    e.$attr[g] = "xlink:href",
                    f = null);
                    e.$observe(b, function(b) {
                        b ? (e.$set(g, b),
                        Ca && f && c.prop(f, e[g])) : "href" === a && e.$set(g, null)
                    })
                }
            }
        }
      ...
      , of = ["$compile", function(a) {
        return {
            ...
            link: function(b, d, c, e) {
                ia.call(d[0]).match(/SVG/) ? (d.empty(),
                a(fd(e.template, w.document).childNodes)(b, function(a) {
                    d.append(a)
                }, {
    ...
    var nf = function() {
            ...
            link: {
                ...
                post: function(d, h, k, l) {
                    ...
                    d.$watchCollection(w.getWatchables, function() {
                        ...
                        (w.trackBy || s ? sa(a, b) : a === b) || (q.$setViewValue(b),
                        q.$render()))
                    })
                }
            }
        ...
        return {
            link: function(f, g, h) {
                ...
                f.$watch(l, function(b) {
                    ...
                    c === w || e && U(w) || (t(),
                    e = q[c],
                    x(e) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m),
                    t = D,
                    k()) : t = f.$watch(e, k),
                    w = c)
                })
      ...
      , mh = ["$element", "$scope", function(a, b) {
        ...
        e.writeValue = function(b) {
            ...
            Ga(z(a[0].options[a[0].selectedIndex]), !0)) : e.selectUnknownOrEmptyOption(b)
        }
        ;
                ...
                pre: function(a, b, d, c) {
                    ...
                    if (f) {
                        ...
                        d.multiple) {
                            ...
                            var g, h = NaN;
                            a.$watch(function() {
                                h !== f.$viewValue || sa(g, f.$viewValue) || (g = ka(f.$viewValue),
                                f.$render());
                                h = f.$viewValue
                            });
    ...
    w.angular.bootstrap ? w.console && console.log("WARNING: Tried to load AngularJS more than once.") : (Be(),
    Ee($),
